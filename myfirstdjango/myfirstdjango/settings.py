...
SECRET_KEY = 'django-insecure-@32cd+r9x%uz_r8w@*c0x3q5tr*35mqk57r7a!ve!)jk1g#)!a'
...
TEMPLATES = [
    {
        ...
        'DIRS': [],               # ничего не указываем — шаблоны будут в папках apps
        'APP_DIRS': True,         # вот это сюда!
        'OPTIONS': {
            'context_processors': [
